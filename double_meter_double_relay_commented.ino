...
for(int p=0;p<2;p++){
  ...
  for(int a=seconds_waiting;a>0;a--)                //first pH read
    {
    lcd.setCursor(0,0);
    lcd.print("place pH ");
...
///////////////////////////////////////////CALIBRATION RESULTS DISPLAY
  ...
  //If you want to print this information to serial also, just add the relevant lines, like Serial.print(what I want to print);
 ...
 // lcd.print("Volt = ");
  ...
  lcd.setCursor(0,0);                    //Do not comment this block if you want to see the coefficient of determination. This is very important!!! The script will run even with an awful R2, although you do get a warning (above)
